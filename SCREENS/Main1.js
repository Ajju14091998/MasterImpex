...
import { Button, View, Text, Pressable, StatusBar ,Image, StyleSheet, TextInput, SafeAreaView, KeyboardAvoidingView } from 'react-native';
      ...
      <KeyboardAvoidingView style={{ flex : 1.2}}>
        ...
        >
            <Tab.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ focused }) => (
                        ...
                        <Ionicons style={styles.i} name="home" size={22} color={focused ? "#fff" : "#000"} />
                        </View>
            ...
            <Tab.Screen
                name="Startsy"
                // component={Startsy}
                children={(props) => <HomeScreen navigation={navigation}/>}
                options={{
                    tabBarLabel: "",
                    tabBarIcon: ({ focused }) => (
                        <View style={focused ? styles.iconc : styles.iconc1}>
                        <View style={focused ? styles.box : styles.box1}>
                            <Cart
                              style={{ width: 20, height: 20 }} // Example to set the size of the icon
                              color={focused ? "#fff" : "#000"} // Dynamically change color based on 'focused' state
                            />
                        </View>
                        {focused && <Text style={styles.navText}>Cart</Text>}
            ...
            <Tab.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ focused }) => (
                        <View style={focused ? styles.iconc : styles.iconc1}>
                        <View style={focused ? styles.box : styles.box1}>
                        <Ionicons style={styles.i} name="person" size={22} color={focused ? "#fff" : "#000"} />
                        </View>
